...
export function MediaUploadCard({ uploadedMedia, onUpdate }: MediaUploadCardProps) {
  ...
  if (!isExpanded) {
    ...
    return (
      <Card
        ref={cardRef}
        className={`p-0 border-2 border-gray-300 hover:border-blue-700 transition-colors duration-300 cursor-pointer ${isValid ? "border-2 border-gray-300 hover:border-blue-700 transition-colors duration-300 cursor-pointer" : ""}`}
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex items-start gap-2 text-sm text-muted-foreground mb-4">
              ...
              <p>
                <span className="font-medium">Pro tip:</span> Use photos that set the mood, and avoid distracting text
                overlays.
              </p>
            </div>
          </div>
