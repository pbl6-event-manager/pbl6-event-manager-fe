...
import { Users, Calendar, Check, Upload, Trash2 } from "lucide-react"
...
import { useLineupAgendaViewModel } from "../../viewmodels/Organizer/lineup-agenda-view-model"
...
export function LineupAndAgendaCard({ eventData, onUpdate }: LineupAndAgendaCardProps) {
  ...
  }, [showAgendaForm, validateAllAgendaForms, saveAgenda])
  ...
  return (
    <Card className="border-2 border-gray-300 hover:border-blue-700 transition-colors duration-300 rounded-lg">
      ...
      <CardContent className="space-y-4">
        ...
        {!showAgendaForm && agendaItems.length === 0 ? (
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <div className="flex items-center gap-3">
          ...
          <div ref={agendaCardRef} className="border-2 border-blue-600 rounded-lg p-6">
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 border-b">
                <Button variant="ghost" size="sm" className="border-b-2 border-blue-600 rounded-none">
                  Agenda
                </Button>
